...
(use-package org
  ...
  (org-block-begin-line ((t (:foreground "#999" :background "#f3f3f3" :slant italic :underline t)))) ;fff4ea
  (org-block-end-line ((t (:foreground "#999" :background "#f3f3f3" :slant italic :underline t))))   ;fff4ea
  (org-block ((t (:background "#fffffa")))) ;fffef5
...
(custom-set-faces
 ...
 '(mode-line          ((t (:inherit mode-line :background "#e0e0f3" :foreground "grey20" :weight light))))
...
- [X] org-indent-mode add org-mode-hooks - [ ] company
- [X] youdao-dictionary
- [ ] smartparens
- [ ] snippets
- [ ] company
